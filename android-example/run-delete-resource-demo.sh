...
echo "[INFO] Compiling DeleteResourceDemo"
javac -cp "$CP" -d android-example/target/classes android-example/src/main/java/com/volcengine/example/tls/DeleteResource.java

echo "[INFO] Running DeleteResourceDemo"
java -cp "$CP" com.volcengine.example.tls.DeleteResource
