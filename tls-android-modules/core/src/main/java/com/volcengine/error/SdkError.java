...
public enum SdkError {
    ...
    SdkError(final int value) { this.value = value; }
    ...
    public static final SdkError getError(int value) { for (SdkError error : SdkError.values()) { if (value == error.value) { return error; } } return UNKNOWN; }
}
