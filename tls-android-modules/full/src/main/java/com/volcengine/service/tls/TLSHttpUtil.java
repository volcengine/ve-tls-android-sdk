...
public class TLSHttpUtil extends BaseServiceImpl {
    ...
    public void setHttpClient(OkHttpClient httpClient) {
        // Use standard client without trust-all hack
        super.setHttpClient(httpClient);
    }

    private OkHttpClient trustAllCertificates(OkHttpClient client) {
        try {
            ...
            LOG.error("Failed to configure trust-all SSL context", e);
            return client;
        }
    }
    ...
    public final static Map<String, ApiInfo> API_INFO_LIST = new HashMap<String, ApiInfo>() {
        {
            ...
            put(com.volcengine.model.tls.Const.DESCRIBE_RULE_V2, new ApiInfo(
                new HashMap<String, Object>() {
                    {
                        put(Const.Method, Const.GET);
                        put(Const.Path, com.volcengine.model.tls.Const.DESCRIBE_RULE_V2);
                        put(Const.Query, new ArrayList<NameValuePair>() {
                        });
                    }
                }
